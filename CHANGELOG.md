...
- **Depo adı `PHP-PDO-MySQL-Ajax-CRUD-DataTables-Bootstrap-5-Modals`
  yerine `php-pdo-ajax-crud` oldu.** Uzun ad adres satırında okunmuyordu ve
...
- **Kök dizin `.htaccess` dosyası eklendi.** Bu depoda böyle bir dosya
  ...
  **Ölçülen açık:** `crud.sql` adresi HTTP **200** ile veritabanı kurulum
  ...
  her yanıta eklenir. Doğrulandı: `crud.sql` artık **403**, uygulama ve
